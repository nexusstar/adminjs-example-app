...
interface FavCreationAttributes
  extends Optional<
    FavAttributes,
    'id' | 'createdAt' | 'updatedAt' | 'publishedAt'
  > {}
interface FavInstance
  extends Model<FavAttributes, FavCreationAttributes>,
    FavAttributes {
  userId: UserInstance;
}
const FavouritePlace = sequelize.define<FavInstance>('FavouritePlace', {
  id: {
    type: DataTypes.UUID,
    allowNull: false,
    primaryKey: true,
